...
`);
                      ...
                      if (t && "boolean" == typeof t.ok && !t.ok) {
                        ...
                        let r =
                          "function" == typeof e.error
                            ? e.error(`HTTP error! status: ${t.status}`)
                            : e.error;
                        this.create({ id: a, type: "error", message: r });
                        ...
                        let r =
                          "function" == typeof e.success
                            ? e.success(t)
                            : e.success;
                        this.create({ id: a, type: "success", message: r });
                      }
                    })
                    .catch((t) => {
                      if (void 0 !== e.error) {
      ...
      var g = (t) => {
        ...
        let {
          ...
          ta = r.useMemo(
            () => b.findIndex((t) => t.toastId === m.id) || 0,
            [b, m.id]
          ),
          tr = r.useMemo(() => m.duration || M || 4e3, [m.duration, M]),
          to = r.useRef(0),
          tn = r.useRef(0),
          ts = (r.useRef(tr), r.useRef(0)),
          ti = r.useRef(null),
          [tl, td] = z.split("-"),
          tc = r.useMemo(
            () => b.reduce((t, e, a) => (a >= ta ? t : t + e.height), 0),
            [b, ta]
          ),
          tu = m.invert || u,
          tm = "loading" === Q;
            ...
            (t.style.height = e),
              ...
              g((t) =>
                t.find((t) => t.toastId === m.id)
                  ...
                  : [{ toastId: m.id, height: a }, ...t]
              );
          }, [D, m.title, m.description, g, m.id]);
        ...
        return (
          r.useEffect(() => {
            if ((m.promise && "loading" === Q) || m.duration === 1 / 0) return;
            let t,
              e = tr;
            return (
              w || h
            ...
            "li",
            {
              ...
              className: p(
                ...
                null == (e = null == m ? void 0 : m.classNames)
                  ...
                  : e.toast,
                null == j ? void 0 : j[Q],
                null == (a = null == m ? void 0 : m.classNames) ? void 0 : a[Q]
              ),
              "data-sonner-toast": "",
              ...
              onPointerDown: (t) => {
                tm ||
                  ...
                  "BUTTON" !== t.target.tagName &&
                    (U(!0), (ti.current = { x: t.clientX, y: t.clientY })));
              },
              onPointerUp: () => {
                var t, e, a, r;
                if (O || !Z) return;
                ...
                let o = Number(
                  ...
                  n =
                    new Date().getTime() -
                    (null == (e = W.current) ? void 0 : e.getTime());
                if (Math.abs(o) >= 20 || Math.abs(o) / n > 0.11) {
                  K(tn.current),
              ...
              onPointerMove: (t) => {
                ...
                Math.abs(o) > n
                  ? null == (e = q.current) ||
                    e.style.setProperty("--swipe-amount", `${a}px`)
                  : Math.abs(r) > n && (ti.current = null);
              },
            },
            k && !m.jsx
              ? r.createElement(
                  "button",
                  {
                    ...
                    className: p(
                      ...
                      null == (o = null == m ? void 0 : m.classNames)
                        ? void 0
                        : o.closeButton
                    ),
                  },
              ...
              : null,
            m.jsx || r.isValidElement(m.title)
              ? m.jsx || m.title
              : r.createElement(
                  r.Fragment,
                  null,
                    ...
                    ? r.createElement(
                        ...
                        (m.promise || "loading" === m.type) && !m.icon
                          ? I
                            ...
                            : r.createElement(i, { visible: "loading" === Q })
                          : null,
                        m.icon || n(Q)
                      )
                    : null,
        ...
        let {
          ...
          B = r.useMemo(
            () =>
              Array.from(
                new Set(
                  [a].concat(k.filter((t) => t.position).map((t) => t.position))
                )
              ),
            [k, a]
          ),
          ...
          j = r.useRef(null),
          A = n.join("+").replace(/Key/g, "").replace(/Digit/g, ""),
          D = r.useRef(null),
          L = r.useRef(!1),
          P = r.useCallback(
                    ...
                    "ol",
                    {
                      ...
                      onFocus: (t) => {
                        (t.target instanceof HTMLElement &&
                          ...
                          L.current ||
                          ((L.current = !0), (D.current = t.relatedTarget));
                      },
                      onMouseEnter: () => M(!0),
                      onMouseMove: () => M(!0),
                      onMouseLeave: () => {
                    ...
                    k
                      ...
                      .map((a, o) => {
                        ...
                        return r.createElement(g, {
                          ...
                          toast: a,
                          duration:
                            null != (n = null == b ? void 0 : b.duration)
                              ? n
                              : m,
