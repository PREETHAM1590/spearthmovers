jQuery(window).on("elementor/frontend/init", function () {
  var e = elementorModules.frontend.handlers.Base.extend({
    ...
    switchWord: function (e, t) {
      e
        .removeClass("twbb-headline-text-active")
        .addClass("twbb-headline-text-inactive"),
        t
          .removeClass("twbb-headline-text-inactive")
          .addClass("twbb-headline-text-active");
    },
    ...
    showWord: function (e, t) {
      ...
      "typing" === s
        ? (i.showLetter(e.find("." + n.classes.dynamicLetter).eq(0), e, !1, t),
          e.addClass(n.classes.textActive).removeClass(n.classes.textInactive))
        : "clip" === s &&
    ...
    hideWord: function (e) {
      ...
      if ("typing" === o)
        ...
        t.hideLetter(e.find(s).eq(0), e, a, i.lettersDelay),
          t.showLetter(r.find(s).eq(0), r, a, i.lettersDelay);
      } else
        "clip" === o
    ...
    fillWords: function () {
      ...
      if ("rotate" === e.headline_style) {
        (e.rotating_text || "").split("\n").forEach(function (e, n) {
          var s = jQuery("<span>", { class: t.dynamicText }).html(
            e.replace(/ /g, "&nbsp;")
          );
          n || s.addClass(t.textActive), i.append(s);
        });
      } else {
        var n = jQuery("<span>", {
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbbanimated-headline.default",
    function (t) {
      new e({ $element: t });
    }
  );
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_code-highlight.default",
      function (t) {
        new e({ $element: t });
      }
    );
...
var tenwebCountdown = function (e, t) {
  var i,
    ...
    s = function () {
      var s = tenwebCountdown.getTimeRemaining(t, n.$monthsSpan.length);
      (jQuery.each(s.parts, function (e) {
        var t = n["$" + e + "Span"],
          i = this.toString();
        1 === i.length && (i = 0 + i), t.length && t.text(i);
      }),
      s.total <= 0) &&
        ("yes" == e.data("hide-after-expiry") &&
          (e.find(".tenweb-countdown-item").addClass("tenweb-hidden"),
          e
            .parent()
            .find(".tenweb-countdown-description")
            .addClass("tenweb-hidden"),
          e
            .parent()
            .find(".tenweb-countdown-expired")
            .removeClass("tenweb-hidden")),
        clearInterval(i));
    };
  s(), (i = setInterval(s, 1e3));
};
(tenwebCountdown.getTimeRemaining = function (e, t) {
  var i = new Date(),
    ...
    o =
      t && s > 31
        ? 12 * (e.getFullYear() - i.getFullYear()) + e.getMonth() - i.getMonth()
        : 0;
  t && o && (s = e.getDate() - i.getDate());
  var r = Math.floor((n / 36e5) % 24),
    a = Math.floor((n / 1e3 / 60) % 60),
    l = Math.floor((n / 1e3) % 60);
  return (
    (s < 0 || r < 0 || a < 0) && (l = a = r = s = 0),
    {
      total: n,
      parts: { months: o, days: s, hours: r, minutes: a, seconds: l },
    }
  );
}),
  jQuery(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbbcountdown.default",
      function (e) {
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    (loadSDK = function () {
      ...
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/twbb_facebook-page.default",
        function (e) {
          t(e);
        }
      ),
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/twbb_facebook-comments.default",
        function (e) {
          t(e);
        }
      ),
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/twbb_facebook-embed.default",
        function (e) {
          t(e);
        }
      ),
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/twbb_facebook-button.default",
        function (e) {
          t(e);
        }
      );
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    var e = elementorModules.frontend.handlers.Base.extend({
      getDefaultSettings: function () {
        return {
          selectors: { hotspot: ".e-hotspot", tooltip: ".e-hotspot__tooltip" },
        };
      },
      getDefaultElements: function () {
      ...
      onHotspotTriggerEvent: function (e) {
        const t = jQuery(e.target),
          ...
          s = "mobile" === elementorFrontend.getCurrentDeviceMode();
        if (
          !(
        ...
        const t = elementorModules.utils.Scroll.scrollObserver({
          callback: (i) => {
            i.isInViewport &&
              ...
              this.elements.$hotspot.each((t, i) => {
                if (0 === t) return;
                const n = e.hotspot_sequenced_animation_duration,
                  s = t * ((n ? n.size : 1e3) / this.elements.$hotspot.length);
                i.style.animationDelay = s + "ms";
              }));
          },
        });
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_hotspot.default",
      function (t) {
        new e({ $element: t });
      }
    );
  ...
  (function (e) {
    ...
    function initMouseDetection(e) {
      ...
      if (mouseDetectionEnabled || e)
        mouseDetectionEnabled &&
          e &&
          ($(document).unbind(t), (mouseDetectionEnabled = !1));
      else {
        var i = !0,
          n = null;
        $(document).bind(
                ...
                function (e) {
                  ...
                  if (n) {
                    ...
                    if (
                      ...
                      s <= 2 &&
                      o <= 2 &&
                      t.timeStamp - n.timeStamp <= 300 &&
                      ((mouse = !0), i)
                    ) {
                      var r = $(e.target).closest("a");
                      r.is("a") &&
                        $.each(menuTrees, function () {
                          if ($.contains(this.$root[0], r[0]))
                            return this.itemEnter({ currentTarget: r[0] }), !1;
                        }),
                        (i = !1);
                    }
                  }
    ...
    return (
      ($.SmartMenus = function (e, t) {
        (this.$root = $(e)),
          ...
          (this.cssTransforms3d =
            "perspective" in e.style || "webkitPerspective" in e.style),
        ...
        prototype: {
            ...
            this.$root
              ...
              .each(function () {
                ...
                e.dataSM("scroll-arrows") && e.dataSM("scroll-arrows").remove(),
                  ...
                  0 == (e.attr("id") || "").indexOf(i.accessIdPrefix) &&
                    e.removeAttr("id");
              })
          ...
          disable: function (e) {
            if (!this.disabled) {
              if (
                (this.menuHideAll(),
                !e && !this.opts.isPopup && this.$root.is(":visible"))
              ) {
          ...
          getClosestMenu: function (e) {
            for (var t = $(e).closest("ul"); t.dataSM("in-mega"); )
          ...
          getOffset: function (e, t) {
            ...
            "none" == e.css("display") &&
              ...
              e.css({ position: "absolute", visibility: "hidden" }).show());
            ...
            return (
              s || 0 === s || (s = t ? e[0].offsetHeight : e[0].offsetWidth),
              i && e.hide().css(i),
              s
            );
          },
          getStartZIndex: function (e) {
            ...
            return (
              !e && isNaN(t) && (t = parseInt(this.$root.css("z-index"))),
              isNaN(t) ? 1 : t
            );
          },
          ...
          itemActivate: function (e, t) {
            ...
            if (
              n > 1 &&
              (!this.activatedItems[n - 2] ||
                this.activatedItems[n - 2][0] != i.dataSM("parent-a")[0])
            ) {
              var s = this;
            ...
            if (
              ((this.isCollapsible() && !t) ||
                this.menuHideSubMenus(
                  this.activatedItems[n - 1] &&
                    this.activatedItems[n - 1][0] == e[0]
                    ? n
                    : n - 1
                ),
          ...
          itemClick: function (e) {
            ...
            if (this.handleItemEvents(t)) {
              if (
                this.$touchScrollingSub &&
                this.$touchScrollingSub[0] == t.closest("ul")[0]
              )
                return (
                  (this.$touchScrollingSub = null), e.stopPropagation(), !1
                );
              if (!1 === this.$root.triggerHandler("click.smapi", t[0]))
                return !1;
              ...
              if (n && !n.is(":visible")) {
                if (
                  (this.opts.showOnClick && s && (this.clickActivated = !0),
                  this.itemActivate(t),
                  n.is(":visible"))
                )
                  return (this.focusActivated = !0), !1;
              } else if (this.isCollapsible() && i)
                return this.itemActivate(t), this.menuHide(n), !1;
              return (
                !(
                  (this.opts.showOnClick && s) ||
                  t.hasClass("disabled") ||
                  !1 === this.$root.triggerHandler("select.smapi", t[0])
                ) && void 0
              );
            }
          },
            ...
            if (this.handleItemEvents(t)) {
              if (!this.isTouchMode()) {
                ...
                this.showTimeout = setTimeout(
                  ...
                  this.opts.showOnClick && 1 == t.closest("ul").dataSM("level")
                    ? 1
          ...
          menuHide: function (e) {
            if (
              !1 !== this.$root.triggerHandler("beforehide.smapi", e[0]) &&
              (e.stop(!0, !0), "none" != e.css("display"))
            ) {
              var t = function () {
                e.css("z-index", "");
              };
              ...
              this.activatedItems.splice(i - 1, 1),
                this.visibleSubMenus.splice(
                  $.inArray(e, this.visibleSubMenus),
                  1
                ),
          ...
          menuHideAll: function () {
            this.showTimeout &&
              (clearTimeout(this.showTimeout), (this.showTimeout = 0));
            for (
              var e = this.opts.isPopup ? 1 : 0,
                t = this.visibleSubMenus.length - 1;
              t >= e;
              t--
            )
          ...
          menuInit: function (e) {
            if (!e.dataSM("in-mega")) {
              ...
              n.length || (n = e.prevAll().find("a").eq(-1)),
                n.addClass("has-submenu").dataSM("sub", e),
                e
                  .dataSM("parent-a", n)
                  .dataSM("level", t)
                  .parent()
          ...
          menuPosition: function (e) {
            var t,
              ...
              y =
                (this.opts.rightToLeftSubMenus && !s.is("[data-sm-reverse]")) ||
                (!this.opts.rightToLeftSubMenus && s.is("[data-sm-reverse]")),
              _ =
                2 == r
            ...
            if (
              (v
                ? ((t = y ? u - a - _ : _),
                  (i = this.opts.bottomToTopSubMenus ? -l - S : m + S))
                : ((t = y ? _ - a : u - _),
                  (i = this.opts.bottomToTopSubMenus ? m - S - l : S)),
              ...
              if (
                (y && C < g
                  ? (t = v ? g - C + t : u - _)
                  : !y && C + a > g + b && (t = v ? g + b - a - C + t : _ - a),
                v ||
                  (l < w && k + l > f + w
                    ? (i += f + w - l - k)
                    : (l >= w || k < f) && (i += f - k)),
                (v && (k + l > f + w + 0.49 || k < f)) || (!v && l > w + 0.49))
              ) {
                var I = this;
                e.dataSM("scroll-arrows") ||
                  e.dataSM(
                ...
                e
                  ...
                  .eq(v && this.opts.bottomToTopSubMenus ? 0 : 1)
                  .show(),
                  this.isFixed() &&
                    e
                      .css({
          ...
          menuScroll: function (e, t, i) {
            var n,
              ...
              r = s.up ? s.upEnd : s.downEnd;
            if (!t && s.momentum) {
              if (((s.momentum *= 0.92), (n = s.momentum) < 0.5))
                return void this.menuScrollStop(e);
            } else
              n =
                i ||
                (t || !this.opts.scrollAccelerate
            ...
            if (
              ...
              (s.y =
                (s.up && r <= s.y) || (!s.up && r >= s.y)
                  ? s.y
                  : Math.abs(r - s.y) > n
                  ? s.y + (s.up ? n : -n)
                  : r),
              e
                .add(e.dataSM("ie-shim"))
                .css(
                  this.cssTransforms3d
                    ? {
              ...
              mouse &&
                ((s.up && s.y > s.downEnd) || (!s.up && s.y < s.upEnd)) &&
                o.eq(s.up ? 1 : 0).show(),
              s.y == r)
            )
              mouse && o.eq(s.up ? 0 : 1).hide(), this.menuScrollStop(e);
            else if (!t) {
              this.opts.scrollAccelerate &&
                s.step < this.opts.scrollStep &&
                (s.step += 0.2);
              var l = this;
          ...
          menuScrollMousewheel: function (e, t) {
            if (this.getClosestMenu(t.target) == e[0]) {
              ...
              e
                ...
                .eq(i ? 0 : 1)
                .is(":visible") &&
                ((e.dataSM("scroll").up = i), this.menuScroll(e, !0));
            }
            t.preventDefault();
          },
          menuScrollOut: function (e, t) {
            mouse &&
              (/^scroll-(up|down)/.test((t.relatedTarget || "").className) ||
                ((e[0] == t.relatedTarget ||
                  $.contains(e[0], t.relatedTarget)) &&
                  this.getClosestMenu(t.relatedTarget) == e[0]) ||
                e.dataSM("scroll-arrows").css("visibility", "hidden"));
          },
          menuScrollOver: function (e, t) {
            if (
              mouse &&
              !/^scroll-(up|down)/.test(t.target.className) &&
              this.getClosestMenu(t.target) == e[0]
            ) {
              this.menuScrollRefreshData(e);
              var i = e.dataSM("scroll"),
                n =
                  $(window).scrollTop() -
                  e.dataSM("parent-a").offset().top -
                  i.itemH;
              e.dataSM("scroll-arrows")
                .eq(0)
                .css("margin-top", n)
          ...
          menuScrollRefreshData: function (e) {
            var t = e.dataSM("scroll"),
              i =
                ...
                t.itemH;
            this.cssTransforms3d &&
              (i = -(parseFloat(e.css("margin-top")) - i)),
              $.extend(t, {
                upEnd: i,
            ...
            if (isTouchEvent((t = t.originalEvent))) {
              ...
              if (this.getClosestMenu(i.target) == e[0]) {
                ...
                if (/(start|down)$/i.test(t.type))
                  this.menuScrollStop(e)
                    ? (t.preventDefault(), (this.$touchScrollingSub = e))
                    : (this.$touchScrollingSub = null),
                    this.menuScrollRefreshData(e),
                    $.extend(n, {
                      touchStartY: i.pageY,
                  ...
                  void 0 !== n.touchY &&
                    ((n.momentum =
                      15 *
                      Math.pow(
                        Math.abs(i.pageY - n.touchStartY) /
                          (t.timeStamp - n.touchStartTime),
                        2
                      )) &&
                      (this.menuScrollStop(e),
                      this.menuScroll(e),
          ...
          menuShow: function (e) {
            if (
              (e.dataSM("beforefirstshowfired") ||
                (e.dataSM("beforefirstshowfired", !0),
                !1 !==
                  this.$root.triggerHandler("beforefirstshow.smapi", e[0]))) &&
              !1 !== this.$root.triggerHandler("beforeshow.smapi", e[0]) &&
              (e.dataSM("shown-before", !0).stop(!0, !0), !e.is(":visible"))
            ) {
              ...
              if (
                ...
                this.menuPosition(e),
                  e.dataSM("ie-shim") && e.dataSM("ie-shim").insertBefore(e);
              }
              var n = function () {
                e.css("overflow", "");
              };
              this.isCollapsible()
                ? this.opts.collapsibleShowFunction
                  ? this.opts.collapsibleShowFunction.call(this, e, n)
                  : e.show(this.opts.collapsibleShowDuration, n)
                : this.opts.showFunction
                ? this.opts.showFunction.call(this, e, n)
                : e.show(this.opts.showDuration, n),
          ...
          popupShow: function (e, t) {
            if (this.opts.isPopup) {
              if (
                ...
                this.opts.showFunction
                  ? this.opts.showFunction.call(this, this.$root, n)
                  : this.$root.show(this.opts.showDuration, n),
              ...
              switch (e.keyCode) {
                case 27:
                  ...
                  if (t)
                    this.menuHideAll(),
                      t[0].focus(),
                      (i = t.dataSM("sub")) && this.menuHide(i);
                  break;
                case 32:
                  var i,
                    n = $(e.target);
      ...
      ($.fn.dataSM = function (e, t) {
        return t
          ? this.data(e + "_smartmenus", t)
          : this.data(e + "_smartmenus");
      }),
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    var e = elementorModules.frontend.handlers.Base.extend({
      ...
      toggleMenu: function (e) {
        ...
        "boolean" != typeof e && (e = !i),
          this.elements.$menuToggle.toggleClass("twbb-active", e),
          e
            ? (t.hide().slideDown(250, function () {
                t.css("display", "");
              }),
      ...
      onInit: function () {
        jQuery("body").hasClass("elementor-editor-active") &&
          ...
          jQuery(".ai-recreated-menu-item").each(function () {
            if (0 == jQuery(this).children("button").length) {
              ...
              jQuery(this).children("a").text("+ Add page"),
                ...
                jQuery(this).prepend(
                  '<button class="twbb-add_new_page"style="height:' +
                    t +
                    "px;width:" +
                    e +
                    'px;"></button>'
          ...
          jQuery(".twbb-add_new_page").click(function (e) {
            let t, i, n, s, o, r, a, l;
            (t = jQuery(this).closest("ul").attr("class")),
              (i = jQuery(this).closest("li").attr("class")),
              (n = new RegExp("twbb-menu_term_id-\\s*(\\d+)")),
              (s = new RegExp("menu-item-\\s*(\\d+)")),
              (o = new RegExp("twbb_menu_order_\\s*(\\d+)")),
              (r = t.match(n)),
              (a = i.match(s)),
              (l = i.match(o)),
              r &&
                ...
                l &&
                window.open(
                  twbb.tenweb_dashboard +
                    "/websites/" +
                    twbb.dashboard_website_id +
                    "/ai-builder?add_page=1&menu_term_id=" +
                    r[1] +
                    "&menu_item_id=" +
                    a[1] +
                    "&menu_item_position=" +
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb-nav-menu.default",
      function (t) {
...
var twbb_widgets = [],
  twbb_posts = function (e, t) {
    ...
    (this.query_args = e.query_args),
      (this.query_args_hash = e.query_args_hash),
      (this.widget_id = e.widget_id),
      (this.settings = e.settings),
      (this.posts = []),
      (this.pages_count = 1),
      (this.init = function () {
        !(function () {
          0 == (o = jQuery('div[data-id="' + i.widget_id + '"]')).length &&
            (o = jQuery(".elementor-global-" + i.widget_id));
          ...
          (function () {
            ...
            var e = "",
              t = "";
            "yes" === settings.show_image &&
              (e =
                "<% if(twbb_image != '') { %><div class='twbb-posts-image'><img src='<%= twbb_image %>'/></div><% } %>");
            "yes" === settings.show_title &&
              (t +=
                "<div class='twbb-posts-title'><" +
                settings.title_tag +
                " class='twbb-posts-title-tag'><a href='<%= twbb_permalink %>'><%= post_title %></a></" +
                settings.title_tag +
                "></div>");
            "above_title" === settings.image_position
              ? (s += e + t)
              : (s += t + e);
            if (
              void 0 !== settings.meta_data &&
              settings.meta_data.length > 0
            ) {
              s += "<div class='twbb-posts-meta-data'>";
              for (var n = 0; n < settings.meta_data.length; n++) {
                switch (settings.meta_data[n]) {
                  case "author":
                    s +=
                      '<span class="twbb-posts-author-meta"><% print(posts_print_author(twbb_author)) %></span>';
                    break;
                  case "date":
                    s +=
                      '<span class="twbb-posts-date-meta"><%= twbb_date %></span>';
                    break;
                  case "time":
                    s +=
                      '<span class="twbb-posts-time-meta"><%= twbb_time %></span>';
                    break;
                  case "comments":
                    s +=
                      '<span class="twbb-posts-comments-meta"><% if(twbb_comments > 0) { %><%=  twbb_comments %> <% }else{ print("No") } print(" comments")%></span>';
                    break;
                  case "categories":
                    s +=
                      '<span class="twbb-posts-categories-meta"><% print(posts_print_terms(twbb_categories, "categories")) %></span>';
                    break;
                  case "tags":
                    s +=
                      '<span class="twbb-posts-tags-meta"><% print(posts_print_terms(twbb_tags, "tags")) %></span>';
                }
                s +=
                  '<span class="twbb-posts-meta-separator">' +
            ...
            "yes" === settings.show_excerpt &&
              (s +=
                "<div class='twbb-posts-content'><%= twbb_excerpt %></div>");
            "yes" === settings.show_read_more &&
              (s +=
                "<div class='twbb-posts-read-more'><a href='<%= twbb_permalink %>'>" +
                settings.read_more_text +
                "</a></div>");
            s = '<div class="twbb-posts-item">' + s + "</div>";
          })(),
          this.get_posts();
      }),
      (this.render = function () {
        ...
        if (0 === this.posts.length)
          return (
            a.addClass("empty-posts"), void a.append("<p>No posts found.</p>")
          );
        for (t in this.posts) (e = i(this.posts[t])), a.append(e);
        this.display_separators(),
          "yes" === this.settings.masonry && this.masonry(),
          "yes" === this.settings.pagination &&
            this.pages_count > 1 &&
            this.pagination();
      }),
      (this.get_posts = function () {
        if ((this.show_loading(), 1 === n && void 0 !== e.first_page_data))
          return (
            (i.posts = e.first_page_data.posts),
            (i.pages_count = e.first_page_data.pages_count),
            i.render(),
            void i.hide_loading()
          );
        jQuery
          ...
          .done(function (e) {
            (i.posts = e.data.posts),
              (i.pages_count = parseInt(e.data.pages_count)),
              i.render(),
              i.hide_loading();
          })
          .fail(function (e) {
      ...
      (this.display_separators = function () {
        jQuery(".twbb-posts-meta-data").each(function () {
          var e = null;
          jQuery(this)
            .find(".twbb-posts-meta-separator")
            .each(function () {
      ...
      (this.pagination = function () {
        var e = "",
          ...
          s = "";
        "yes" === this.settings.pagination_first_last_buttons &&
          ((s = "twbb-posts-page twbb-posts-page-first"),
          1 === n && (s += " " + t),
          (e += get_page_link_html(
            s,
            1,
            this.settings.pagination_first_label
          ))),
          "yes" === this.settings.pagination_next_prev_buttons &&
            ((s = "twbb-posts-page twbb-posts-page-prev"),
            1 === n && (s += " " + t),
            (e += get_page_link_html(
              s,
              n - 1,
              this.settings.pagination_prev_label
            )));
        var l =
          this.pages_count > this.settings.pagination_page_limit
            ? this.settings.pagination_page_limit
            : this.pages_count;
        if ("yes" === this.settings.pagination_number_buttons)
          for (var d = 1; d <= l; d++)
            (s = "twbb-posts-page twbb-posts-page-num"),
              d === n && (s += " twbb-posts-current-page " + t),
              (e += get_page_link_html(s, d, d));
        "yes" === this.settings.pagination_next_prev_buttons &&
          ((s = "twbb-posts-page twbb-posts-page-next"),
          n === this.pages_count && (s += " " + t),
          (e += get_page_link_html(
            s,
            n + 1,
            this.settings.pagination_next_label
          ))),
          "yes" === this.settings.pagination_first_last_buttons &&
            ((s = "twbb-posts-page twbb-posts-page-last"),
            n === this.pages_count && (s += " " + t),
            (e += get_page_link_html(
              s,
              l,
              this.settings.pagination_last_label
            ))),
          null === r
            ? ((e =
                "yes" === this.settings.pagination_scroll_top
                  ? "<div class='twbb-posts-pagination twbb-pagination_scroll_top'>" +
                    e +
                    "</div>"
                  : "<div class='twbb-posts-pagination'>" + e + "</div>"),
              a.parent().append(e),
              (r = o.find(".twbb-posts-pagination")))
            : r.append(e),
          r.find(".twbb-posts-page").on("click", function (e) {
            ...
            return (
              t < 1 ||
                ...
                ((n = t),
                i.get_posts(),
                jQuery(this).parent().hasClass("twbb-pagination_scroll_top") &&
      ...
      (this.show_loading = function () {
        null === l
          ? (o.append(
              '<div class="twbb-posts-loading"><i class="twbb-spinner-solid"></i></div>'
            ),
            (l = jQuery(o.find(".twbb-posts-loading"))))
          : l.show();
      }),
      ...
      (get_page_link_html = function (e, t, i) {
        return (
          "<a href='#' class='" + e + "' data-page='" + t + "'>" + i + "</a>"
        );
      }),
      (posts_print_author = function (e) {
        return "yes" === i.settings.author_meta_link
      ...
      (posts_print_terms = function (e, t) {
        var n = "",
          s = "tags" === t ? "#" : "",
          o =
            ("categories" === t && "yes" === i.settings.categories_meta_link) ||
            ("tags" === t && "yes" === i.settings.tags_meta_link);
        for (var r in e)
          n +=
            !0 === o
              ? "<a href='" + e[r].link + "'>" + s + e[r].name + "</a>, "
              : s + e[r].name + ", ";
        return n.trim().slice(0, n.length - 2);
      }),
      (this.clear_html = function () {
        null !== a && a.html(""),
          null !== r &&
            (r.html(""), "yes" === i.settings.masonry && a.masonry("destroy"));
      }),
      this.init(),
      twbb_add_widget(t, this);
  };
...
jQuery(window).on("elementor/frontend/init", function () {
  ...
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb-posts.default",
    e
  ),
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb-posts-archive.default",
      e
    );
}),
  (function (e) {
    var t = function (i, n) {
      var s,
        ...
        r = function (e) {
          var i = "";
          if (o.width && o.height) {
            var n = screen.width / 2 - o.width / 2,
              s = screen.height / 2 - o.height / 2;
            i =
          ...
          var r = (function (e) {
              var i = t.networkTemplates[e].replace(
                /{([^}]+)}/g,
                function (t, i) {
                  if ("twitter" == e && "text" == i) {
                    var n = jQuery(jQuery.parseHTML(o[i]))
                        .text()
                        .replace(/\s\s+/g, " "),
                      s = window.location.href;
                    o[i] = n.substr(0, 345 - s.length) + " ...";
                  }
                  return o[i];
                }
              );
        ...
        a = function () {
          e.each(i.classList, function () {
            var e,
              t =
                (e = this).substr(0, o.classPrefixLength) === o.classPrefix
                  ? e.substr(o.classPrefixLength)
                  : null;
            if (t)
              return (
                (function (e) {
      ...
      e.extend(o, t.defaultSettings, n),
        ["title", "text"].forEach(function (e) {
          o[e] = o[e].replace("#", "");
        }),
        (o.classPrefixLength = o.classPrefix.length),
        (s = e(i)),
        a();
    };
    (t.networkTemplates = {
      ...
      odnoklassniki:
        "http://odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl={url}",
    ...
    (e = t.extend({
      onInit: function () {
        ...
        var e = this.getElementSettings(),
          ...
          s = { classPrefix: i.shareLinkPrefix };
        n
      ...
      elementorFrontend.isEditMode() ||
        elementorFrontend.hooks.addAction(
          "frontend/element_ready/twbbshare-buttons.default",
          function (t) {
            new e({ $element: t });
          }
        );
      ...
      bindEvents: function () {
        ...
        "full_screen" === r
          ? (e.elements.$toggle.on("click", function () {
              t.toggleClass(a.isFullScreen).toggleClass(a.lightbox), n.focus();
            }),
          ...
          : n.on({
              focus: function () {
                s.addClass(a.isFocus);
              },
              blur: function () {
                s.removeClass(a.isFocus);
              },
            }),
          "minimal" === r &&
            o.on("click", function () {
              s.addClass(a.isFocus), n.focus();
            });
      },
    });
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbbsearch-form.default",
      function (t) {
        new e({ $element: t });
      }
    );
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    var e = elementorModules.frontend.handlers.Base.extend({
      ...
      getContainer: function () {
        ...
        return "popup" === i.attr("data-elementor-type")
          ? i
      ...
      getHeadings: function () {
        ...
        return this.elements.$pageContainer
          ...
          .not(i.headerTitle)
          .filter(function (e, t) {
            return !jQuery(t).closest(n).length;
          });
      },
      addAnchorsBeforeHeadings: function () {
        ...
        this.elements.$headings.before(function (i) {
          if (!jQuery(e.elements.$headings[i]).data("hasOwnID"))
            return '<span id="'
      ...
      activateItem: function (e) {
        ...
        e.addClass(i.activeItem),
        (this.$activeItem = e),
        this.getElementSettings("collapse_subitems")) &&
          ((t = e.hasClass(i.firstLevelListItem)
            ? e.parent().next()
            : e.parents("." + i.listWrapper).eq(-2)).length
        ...
        elementorFrontend.waypoint(
          ...
          function (s) {
            if (!n.itemClicked) {
              var o = i.attr("id");
              "down" === s
                ? ((n.viewportItems[o] = !0), n.activateItem(e))
                : (delete n.viewportItems[o],
      ...
      getNestedLevel: function (e) {
        for (
          ...
          if (
            (0 === o.level && (r += " " + t.classes.firstLevelListItem),
            e > o.level)
          )
            break;
          if (e === o.level) {
            (s += '<li class="'.concat(t.classes.listItem, '">')),
              (s += '<div class="'.concat(t.classes.listTextWrapper, '">'));
            var a = '<a href="#'
              .concat(o.anchorLink, '" class="')
              .concat(r, '">')
              .concat(o.text, "</a>");
            "bullets" === i.marker_view &&
              n &&
              (a = '<i class="'.concat(n.value, '"></i>').concat(a)),
              (s += a),
              (s += "</div>"),
              this.listItemPointer++;
            var l = this.headingsData[this.listItemPointer];
            l && e < l.level && (s += this.getNestedLevel(l.level)),
              (s += "</li>");
          }
        }
      ...
      getHeadingAnchorLink: function (e, t) {
        ...
        return (
          ...
          i || n
            ...
            : (s = "".concat(t.headingAnchor, "-").concat(e)),
          s
        );
      },
      setHeadingsData: function () {
        ...
        this.headingsData = [];
        var t = this.getSettings("classes");
        this.elements.$headings.each(function (i, n) {
          var s = e.getHeadingAnchorLink(i, t);
          e.headingsData.push({
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_table-of-contents.default",
      function (t) {
        new e({ $element: t });
      }
    );
...
class TWBB_WooCommerce_Base extends elementorModules.frontend.handlers.Base {
  ...
  activateStickyRightColumn() {
    ...
    t.length && "fixed" === t.css("position") && (n += t.height()),
      "yes" === this.getElementSettings("sticky_right_column") &&
        (this.elements.$stickyRightColumn.addClass(i.stickyRightColumnActive),
  ...
  updateWpReferers() {
    ...
    i.searchParams.set("elementorPageId", elementorFrontend.config.post.id),
      i.searchParams.set("elementorWidgetId", this.getID()),
      t.attr("value", i);
  }
}
jQuery(window).on("elementor/frontend/init", function () {
  var e = elementorModules.frontend.handlers.Base.extend({
      ...
      updateSpaceBetween: function (e, t) {
        ...
        if ("desktop" !== n) {
          ...
          e.params.breakpoints[r[n]].spaceBetween = s;
      ...
      getDefaultSettings: function () {
        ...
        return (
          this.isSlideshow() &&
            ...
            (t.slidesPerView = { desktop: 5, tablet: 4, mobile: 3 })),
          t
        );
      },
      getElementSettings: function (t) {
        return (
          -1 !== this.slideshowSpecialElementSettings.indexOf(t) &&
            this.isSlideshow() &&
            (t = "slideshow_" + t),
          e.prototype.getElementSettings.call(this, t)
        );
      },
      getDefaultElements: function () {
        ...
        return (
          this.isSlideshow() &&
            (i.$thumbsSwiper = this.$element.find(t.thumbsSwiper)),
          i
        );
      },
      getEffect: function () {
        return "coverflow" === this.getElementSettings("skin")
          ? "coverflow"
          : e.prototype.getEffect.apply(this, arguments);
      },
      getSlidesPerView: function (t) {
        return this.isSlideshow()
          ? 1
          : "coverflow" === this.getElementSettings("skin")
          ? this.getDeviceSlidesPerView(t)
          : e.prototype.getSlidesPerView.apply(this, arguments);
      },
      getSwiperOptions: function () {
      ...
      async onInit() {
        ...
        if (this.isSlideshow() && !(1 >= t)) {
          ...
          (this.swipers.main.controller.control = this.swipers.thumbs =
            new Swiper(this.elements.$thumbsSwiper, r)),
        ...
        1 >= this.getSlidesCount() ||
          (this.isSlideshow()
            ? (0 === t.indexOf("width") &&
              ...
              0 === t.indexOf("space_between") &&
                this.updateSpaceBetween(this.swipers.thumbs, t))
            : e.prototype.onElementChange.apply(this, arguments));
      },
    });
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb_media-carousel.default",
    function (e) {
      e.find(
        ".elementor-widget-twbb_media-carousel .tenweb-media-carousel-swiper"
      );
      new t({ $element: e });
    }
  );
...
var posts_base = elementorModules.frontend.handlers.Base.extend({
    ...
    fitImage(e) {
      var t = this.getSettings(),
        ...
        n = i.find("img")[0];
      if (n) {
        var s = i.outerHeight() / i.outerWidth(),
          o = n.naturalHeight / n.naturalWidth;
        i.toggleClass(t.classes.fitHeight, o < s);
      }
    },
    fitImages() {
      var e = jQuery,
      ...
      this.elements.$postsContainer.toggleClass(
        ...
        t.isMasonryEnabled() ||
          this.elements.$posts.each(function () {
            var i = e(this),
              s = i.find(n.selectors.postThumbnailImage);
            t.fitImage(i),
              s.on("load", function () {
                t.fitImage(i);
              });
    ...
    setColsCountSettings() {
      ...
      switch (t) {
        case "mobile":
          e = i[n + "columns_mobile"];
          break;
        case "tablet":
          e = i[n + "columns_tablet"];
          break;
        default:
          e = i[n + "columns"];
      }
    ...
    runMasonry() {
      ...
      if ((e.$postsContainer.toggleClass("elementor-posts-masonry", i), i)) {
        ...
        "" === this.getSkinPrefix() &&
          "" === n &&
          (n = this.getElementSettings(this.getSkinPrefix() + "item_gap.size")),
  ...
  portfolio = posts_base.extend({
    ...
    getDefaultElements() {
      ...
      return (
        (e.$filterButtons = this.$element.find(".elementor-portfolio__filter")),
        e
      );
    },
    getOffset(e, t, i) {
      var n = this.getSettings(),
        s = this.elements.$postsContainer.width() / n.colsCount - t;
      return {
        start: (t + (s += s / (n.colsCount - 1))) * (e % n.colsCount),
        top: (i + s) * Math.floor(e / n.colsCount),
      };
    },
    getClosureMethodsNames() {
      return posts_base.prototype.getClosureMethodsNames
        .apply(this, arguments)
    ...
    filterItems(e) {
      ...
      "__all" !== e
        ? (t.not(n).removeClass(i), t.filter(n).addClass(i))
        : t.addClass(i);
    },
    ...
    handleEmptyColumns() {
      ...
      for (
        var e = this.getSettings(),
          t = this.elements.$posts.filter(":visible"),
          i = this.elements.$postsContainer.find("." + e.classes.ghostItem),
          n =
            (e.colsCount - ((t.length + i.length) % e.colsCount)) % e.colsCount,
          s = 0;
        s < n;
        s++
      )
        this.elements.$postsContainer.append(
          jQuery("<div>", { class: e.classes.item + " " + e.classes.ghostItem })
        );
    },
    showItems(e) {
      e.show(),
    ...
    arrangeGrid() {
      var e = jQuery,
        t = this,
        i = t.getSettings(),
        n = t.elements.$posts.filter("." + i.classes.active),
        s = t.elements.$posts.not("." + i.classes.active),
      ...
      c.css({ opacity: 0, transform: "scale3d(0.2, 0.2, 1)" }),
        a.each(function () {
          var i = e(this),
            n = t.getOffset(r.index(i), d, h),
            s = t.getOffset(o.index(i), d, h);
          (n.start === s.start && n.top === s.top) ||
            ((s.start -= n.start),
            (s.top -= n.top),
        ...
        setTimeout(function () {
          n.each(function () {
            var s = e(this),
              o = t.getOffset(r.index(s), d, h),
              a = t.getOffset(n.index(s), d, h);
            s.css({ transitionDuration: i.transitionDuration + "ms" }),
              (a.start -= o.start),
              (a.top -= o.top),
    ...
    activeFilterButton(e) {
      var t = this.getSettings("classes.active"),
        ...
        n = i.filter('[data-filter="' + e + '"]');
      i.removeClass(t), n.addClass(t);
    },
    setFilter(e) {
...
jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb_portfolio.default",
    function (e) {
      new portfolio({ $element: e });
    }
  );
}),
  (function (e, t) {
    (tenwebParallax = function (i, n) {
      var s = {
        vertical_scroll: { active: !1, direction: "up", speed: 4 },
        horizontal_scroll: { active: !1, direction: "right", speed: 4 },
        transparency: { active: !1, direction: "in", speed: 5 },
        blur: { active: !1, direction: "in", speed: 10 },
        scale: { active: !1, direction: "in", speed: 10 },
      };
      this.element = i;
      var o = {};
      !(function (e) {
        (o = s), "object" != typeof e && (o = s);
        let t = Object.entries(e);
        for (let e = 0; e < t.length; e++)
          "object" == typeof t[e] &&
            "object" == typeof s[t[e][0]] &&
            "object" == typeof t[e][1] &&
            (void 0 !== t[e][1].active &&
              ["on", "yes", "On", "Yes", !0].includes(t[e][1].active) &&
              (o[t[e][0]].active = !0),
            void 0 !== t[e][1].speed &&
              0 <= t[e][1].speed <= 10 &&
              (o[t[e][0]].speed = t[e][1].speed),
            void 0 !== t[e][1].direction &&
              ["in", "out", "up", "down"].includes(t[e][1].direction) &&
              (o[t[e][0]].direction = t[e][1].direction));
      })(n),
        (this.layerDiv = (function () {
          var n = e.createElement("div");
          n.classList.add("tenweb-elementor-scrolling-effects-container");
          var s = e.createElement("div");
          s.classList.add("tenweb-elementor-scrolling-effects-layer");
          var o = i.currentStyle || t.getComputedStyle(i, null);
          return (
            (s.style.backgroundImage = o.backgroundImage),
            (s.style.backgroundPosition = o.backgroundPosition),
            (s.style.backgroundRepeat = o.backgroundRepeat),
            (s.style.backgroundSize = o.backgroundSize),
            n.appendChild(s),
            i.prepend(n),
            s
          );
      ...
      (tenwebParallax.prototype = {
        vertical_transform: function () {
          if (this.options.vertical_scroll.active) {
            if (
              ((this.layerDiv.style.height =
                100 + (100 * this.options.vertical_scroll.speed) / 10 + "%"),
              this.isElementVisible())
            ) {
              var e =
                  (this.element.offsetHeight *
                    this.options.vertical_scroll.speed) /
                  2 /
                  10,
                i =
                  (-(t.scrollY + t.innerHeight - this.element.offsetTop) *
                    this.options.vertical_scroll.speed) /
                  4 /
                  10;
              return (
                "down" == this.options.vertical_scroll.direction && (i = -i),
                "translateY(calc(-" + e + "px + " + i + "px))"
              );
            }
            return "";
          }
        ...
        horizontal_transform: function () {
          if (this.options.horizontal_scroll.active) {
            if (
              ((this.layerDiv.style.width =
                100 + (100 * this.options.horizontal_scroll.speed) / 10 + "%"),
              this.isElementVisible())
            ) {
              var e =
                  ((t.scrollY + t.innerHeight - this.element.offsetTop) *
                    this.options.horizontal_scroll.speed) /
                  4 /
                  10,
                i =
                  ...
                  10;
              return (
                "left" == this.options.horizontal_scroll.direction && (e = -e),
                "translateX(calc(-" + i + "px + " + e + "px))"
              );
            }
            return "";
          }
        ...
        transparency: function () {
          return this.options.transparency.active && this.isElementVisible()
            ? ((opacity_value =
                (t.scrollY + t.innerHeight - this.element.offsetTop) /
                (this.element.offsetHeight + t.innerHeight)),
              (opacity_value *= this.options.transparency.speed / 10),
              "out" == this.options.transparency.direction &&
                (opacity_value = 1 - opacity_value),
              opacity_value)
            : "";
        },
        blur: function () {
          return this.options.blur.active && this.isElementVisible()
            ? ((blur_value =
                (t.scrollY + t.innerHeight - this.element.offsetTop) /
                (this.element.offsetHeight + t.innerHeight)),
              (blur_value *= this.options.blur.speed),
              "out" == this.options.blur.direction &&
                (blur_value = 10 - blur_value),
              "blur(" + blur_value + "px)")
            : "";
        },
        scale: function () {
          return this.options.scale.active && this.isElementVisible()
            ? ((scale_value =
                (t.scrollY + t.innerHeight - this.element.offsetTop) /
                (this.element.offsetHeight + t.innerHeight)),
              (scale_value = (scale_value * this.options.scale.speed) / 10),
              (scale_value += 1),
              "out" == this.options.scale.direction &&
        ...
        onScroll: function () {
          ...
          (e += this.horizontal_transform()),
            (e += this.scale()),
            (this.layerDiv.style.transform = e),
        ...
        isElementVisible: function () {
          ...
          return (
            i.top + i.height >= 0 &&
            i.top <= (t.innerHeight || e.documentElement.clientHeight)
          );
        },
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    var e = elementorModules.frontend.handlers.Base.extend({
      ...
      updateSettings: function (e) {
        var t = this;
        for (const [i, n] of Object.entries(t.defoult_settings))
          void 0 !== e[i]
            ? (t.current_settings[i] = e[i])
            : (t.current_settings[i] = t.defoult_settings[i]);
      },
      ...
      activate: function () {
        var e = this,
          t = e.$element[0];
        e.is_active && e.deactivate(),
          (e.curParalax = new tenwebParallax(t, {
            vertical_scroll: {
              active: e.current_settings.tenweb_vertical_scroll_efects,
              speed:
                e.current_settings["tenweb_vertical_scroll_efects-speed"].size,
              direction:
                e.current_settings["tenweb_vertical_scroll_efects-direction"],
            },
            horizontal_scroll: {
              active: e.current_settings.tenweb_horizontal_scroll_efects,
              speed:
                e.current_settings["tenweb_horizontal_scroll_efects-speed"]
                  .size,
              direction:
                e.current_settings["tenweb_horizontal_scroll_efects-direction"],
            },
            transparency: {
              active: e.current_settings.tenweb_transparency_efects,
              speed:
                e.current_settings["tenweb_transparency_efects-speed"].size,
              direction:
                e.current_settings["tenweb_transparency_efects-direction"],
            },
            blur: {
      ...
      deactivate: function () {
        var e = this;
        e.$element[0];
        "function" == typeof e.curParalax.destroy && e.curParalax.destroy(),
          (e.is_active = !1);
      },
      run: function (e) {
        ...
        if (this.isSectionParallax(t))
          if (
            ...
            "yes" === this.current_settings.tenweb_enable_parallax_efects &&
              "classic" === this.current_settings.background_background)
          ) {
            var i = elementorFrontend.getCurrentDeviceMode();
            -1 !== this.getElementSettings("tenweb_parallax_on").indexOf(i)
              ? this.activate()
              : this.deactivate();
...
var _circularProgress = class {
    constructor(e, t) {
      (this.settings = t),
        ...
        (this.circularProgressTracker = e.find(
          ".elementor-scrolling-tracker-circular"
        )[0]),
        (this.circularCurrentProgress =
          this.circularProgressTracker.getElementsByClassName(
            "current-progress"
          )[0]),
        (this.circularCurrentProgressPercentage =
          this.circularProgressTracker.getElementsByClassName(
            "current-progress-percentage"
          )[0]);
      const i = 2 * this.circularCurrentProgress.r.baseVal.value * Math.PI;
      (this.circularCurrentProgress.style.strokeDasharray = `${i} ${i}`),
        (this.circularCurrentProgress.style.strokeDashoffset = i),
    ...
    cacheElements() {
      return {
        ...
        circularCurrentProgressPercentage:
          this.circularCurrentProgressPercentage,
      };
    }
    updateProgress(e) {
      if (e <= 0)
        return (
          ...
          void (this.elements.circularCurrentProgressPercentage.style.display =
            "none")
        );
      (this.elements.circularCurrentProgress.style.display = "block"),
        (this.elements.circularCurrentProgressPercentage.style.display =
          "block");
      const t =
          2 * this.elements.circularCurrentProgress.r.baseVal.value * Math.PI,
        i = t - (e / 100) * t;
      (this.lastKnownProgress = e),
        (this.elements.circularCurrentProgress.style.strokeDasharray = `${t} ${t}`),
        (this.elements.circularCurrentProgress.style.strokeDashoffset =
          "ltr" === this.settings.direction ? -i : i),
        "yes" === this.settings.percentage &&
          (this.elements.circularCurrentProgressPercentage.innerHTML =
            Math.round(e) + "%");
    }
    onDestroy() {
  ...
  _linearProgress = class {
    constructor(e, t) {
      (this.settings = t),
        (this.linearProgressTracker = e.find(
          ".elementor-scrolling-tracker-horizontal"
        )[0]),
        (this.linearCurrentProgress =
          this.linearProgressTracker.getElementsByClassName(
            "current-progress"
          )[0]),
        (this.linearCurrentProgressPercentage =
          this.linearProgressTracker.getElementsByClassName(
            "current-progress-percentage"
          )[0]),
        (this.elements = this.cacheElements());
    ...
    updateProgress(e) {
      e < 1
        ...
        : ((this.elements.linearCurrentProgress.style.display = "flex"),
          (this.elements.linearCurrentProgress.style.width = e + "%"),
          "yes" === this.settings.percentage &&
          this.elements.linearCurrentProgress.getBoundingClientRect().width >
            1.5 *
              this.elements.linearCurrentProgressPercentage.getBoundingClientRect()
                .width
            ? ((this.elements.linearCurrentProgressPercentage.innerHTML =
                Math.round(e) + "%"),
              (this.elements.linearCurrentProgressPercentage.style.color =
                getComputedStyle(this.linearCurrentProgress).getPropertyValue(
                  "--percentage-color"
                )))
            : (this.elements.linearCurrentProgressPercentage.style.color =
                "transparent"));
  ...
  ProgressTracker = class extends elementorModules.frontend.handlers.Base {
    onInit() {
      ...
      (this.progressBar = new e(this.$element, this.getElementSettings())),
    ...
    getTrackingElementSelector() {
      ...
      switch (this.getElementSettings().relative_to) {
        ...
        default:
          e = this.isScrollSnap()
            ? jQuery("#e-scroll-snap-container")
    ...
    addScrollSnapContainer() {
      this.isScrollSnap() &&
        !jQuery("#e-scroll-snap-container").length &&
    ...
    scrollHandler() {
      ...
      const e = this.getTrackingElementSelector(),
        t =
          e.is(elementorFrontend.elements.$body) ||
          e.is(jQuery("#e-scroll-snap-container"))
            ? -100
            : 0;
      (this.progressPercentage =
        elementorModules.utils.Scroll.getElementViewportPercentage(
          this.getTrackingElementSelector(),
          { start: t, end: -100 }
        )),
    ...
    initListeners() {
      window.addEventListener("scroll", this.handler),
        elementorFrontend.elements.$body[0].addEventListener(
          "scroll",
          this.handler
        );
    }
    onDestroy() {
      this.progressBar.onDestroy && this.progressBar.onDestroy(),
        window.removeEventListener("scroll", this.handler),
        elementorFrontend.elements.$body[0].removeEventListener(
          "scroll",
          this.handler
        );
    }
...
jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb_progress-tracker.default",
    function (e) {
      new ProgressTracker({ $element: e });
    }
  );
}),
...
jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb_reviews.default",
    function (e) {
      new TestimonialCarousel({ $element: e });
    }
  );
}),
  jQuery(window).on("elementor/frontend/init", function () {
          ...
          t = {
            ...
            on: {
              slideChange: function () {
                ...
                this.$activeImage && this.$activeImage.removeClass(e),
                  (this.$activeImage = jQuery(
                    this.slides[this.activeIndex]
                  ).children()),
                  this.$activeImage.addClass(e);
              },
            },
          },
          i = {},
      ...
      editButtonChange: function (e) {
        if (
          ...
          (elementor
            .getPanelView()
            .getCurrentPageView()
            .$el.find(".elementor-repeater-fields .elementor-edit-template")
            .remove(),
          this.$element.find(
            ".elementor-widget-container .elementor-swiper .twbb_slides-wrapper .swiper-wrapper .swiper-slide-template.swiper-slide-active"
          ).length)
        ) {
          var t = this.$element
              .find(
            ...
            i =
              twbb.home_url +
              "/wp-admin/edit.php?post_type=elementor_library&tabs_group=twbb_templates&elementor_library_type=twbb_slide",
            n = "Add";
          t &&
            ((i =
              twbb.home_url +
          ...
          var s = jQuery("<a />", {
            target: "_blank",
            class:
              "elementor-button elementor-button-default elementor-edit-template",
            href: i,
            html: '<i class="eicon-pencil"></i>' + n,
          });
          elementor
            .getPanelView()
            .getCurrentPageView()
            .$el.find(".elementor-control-template_id")
            .after(s);
        }
      },
      onInit: function () {
        elementorModules.frontend.handlers.Base.prototype.onInit.apply(
          ...
          jQuery("body").hasClass("elementor-editor-active") &&
            elementor.hooks.addAction(
              "panel/open_editor/widget/twbb_slides",
              this.editButtonChange
            ),
          this.initSlider();
      },
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_slides.default",
      function (t) {
        new e({ $element: t });
      }
    );
      ...
      var n,
        ...
        u = function (e, t, i) {
          ...
          i.forEach(function (e) {
            ...
            e.data("css-backup-" + t, n);
        },
        m = function (e, t) {
          return e.data("css-backup-" + t);
        };
      const p = () => {
        if (((r = v(n, "width")), (o = n.offset().left), s.isRTL)) {
          const e = s.handleScrollbarWidth
            ? window.innerWidth
      ...
      var g = function () {
        ...
        b = function () {
          ...
          (e[s.to] = s.offset),
            ...
            o && (e["inset-inline-start"] = o + "px"),
            n.css(e).addClass(s.classes.stickyActive);
        },
        w = function () {
          n.css(m(n, "unsticky")).removeClass(s.classes.stickyActive);
        },
        v = function (e, t, i) {
          var n = getComputedStyle(e[0]),
            ...
            r = [];
          return (
            "border-box" !== n.boxSizing && r.push("border", "padding"),
            i && r.push("margin"),
        ...
        y = function (e) {
          var t = d.$window.scrollTop(),
            ...
            o = s - n;
          return {
            top: { fromTop: s, fromBottom: o },
            bottom: { fromTop: s + i, fromBottom: o + i },
          };
        },
        _ = function () {
          w(), f(), (a = !1), n.trigger("sticky:unstick");
        },
        S = function () {
          var e = y(n),
            t = "top" === s.to;
          if (l) {
            (t ? e.top.fromTop > s.offset : e.bottom.fromBottom < -s.offset) &&
              (d.$parent.css(m(d.$parent, "childNotFollowing")),
              n.css(m(n, "notFollowing")),
              (l = !1));
          } else {
            var i = y(d.$parent),
              a = getComputedStyle(d.$parent[0]),
              c = parseFloat(a[t ? "borderBottomWidth" : "borderTopWidth"]),
              h = t ? i.bottom.fromTop - c : i.top.fromBottom + c;
            (t ? h <= e.bottom.fromTop : h >= e.top.fromBottom) &&
              (function () {
                u(d.$parent, "childNotFollowing", ["position"]),
                ...
                if (((o = d.$spacer.position().left), s.isRTL)) {
                  const e = n.parent().outerWidth(),
                    t = d.$spacer.position().left;
                  (r = d.$spacer.outerWidth()), (o = Math.max(e - r - t, 0));
                }
                (e["inset-inline-start"] = o + "px"),
                  (e[s.to] = ""),
        ...
        $ = function () {
          ...
          if (a) {
            var i = y(d.$spacer);
            (e = "top" === s.to ? i.top.fromTop - t : -i.bottom.fromBottom - t),
              s.parent && S(),
              e > 0 && _();
          } else {
            var o = y(n);
            (e =
              "top" === s.to ? o.top.fromTop - t : -o.bottom.fromBottom - t) <=
              0 &&
              (p(),
              g(),
              b(),
          ...
          !(function (e) {
            c && -e < s.effectsOffset
              ? (n.removeClass(s.classes.stickyEffects), (c = !1))
              : !c &&
                -e >= s.effectsOffset &&
                (n.addClass(s.classes.stickyEffects), (c = !0));
          })(e);
        },
        C = function () {
          $();
        ...
        k = function () {
          a && (w(), f(), p(), g(), b(), s.parent && ((l = !1), S()));
        };
      (this.destroy = function () {
        a && _(),
          d.$window.off("scroll", C).off("resize", k),
          n.removeClass(s.classes.sticky);
      }),
        (s = jQuery.extend(!0, h, i)),
        (n = e(t).addClass(s.classes.sticky)),
        (d.$window = e(window)),
        s.parent &&
          ((d.$parent = n.parent()),
          "parent" !== s.parent && (d.$parent = d.$parent.closest(s.parent))),
        d.$window.on({ scroll: C, resize: k }),
        $();
    };
      ...
      return (
        this.each(function () {
          ...
          if (n) {
            ...
            o[i].apply(o, Array.prototype.slice.call(arguments, 1)),
              "destroy" === i && s.removeData("sticky");
          } else s.data("sticky", new t(this, i));
        }),
        this
      );
    }),
  ...
  (function (e) {
    var t = function (t, i) {
      ...
      const m = () => {
        if (((r = w(n, "width")), (o = n.offset().left), s.isRTL)) {
          const e = s.handleScrollbarWidth
            ? window.innerWidth
            : document.body.offsetWidth;
          o = Math.max(e - r - o, 0);
      ...
      var p = function () {
        ...
        b = function () {
          n.css(u(n, "unsticky")).removeClass(s.classes.stickyActive);
        },
        w = function (e, t, i) {
          var n = getComputedStyle(e[0]),
            s = parseFloat(n[t]),
        ...
        y = function () {
          b(), g(), (a = !1), n.trigger("sticky:unstick");
        },
        _ = function () {
          var e = v(n),
            t = "top" === s.to;
          if (l)
            (t ? e.top.fromTop > s.offset : e.bottom.fromBottom < -s.offset) &&
              (d.$parent.css(u(d.$parent, "childNotFollowing")),
              n.css(u(n, "notFollowing")),
              (l = !1));
          else {
            var i = v(d.$parent),
              a = getComputedStyle(d.$parent[0]),
              c = parseFloat(a[t ? "borderBottomWidth" : "borderTopWidth"]),
              m = t ? i.bottom.fromTop - c : i.top.fromBottom + c;
            (t ? m <= e.bottom.fromTop : m >= e.top.fromBottom) &&
              (function () {
                h(d.$parent, "childNotFollowing", ["position"]),
                  d.$parent.css("position", "relative"),
                  h(n, "notFollowing", [
                    "position",
                    "inset-inline-start",
        ...
        C = function () {
          a && (b(), g(), m(), p(), f(), s.parent && ((l = !1), _()));
        };
      (this.destroy = function () {
        a && y(),
          d.$window.off("scroll", $).off("resize", C),
          n.removeClass(s.classes.sticky);
      }),
        (s = jQuery.extend(
          !0,
    ...
    var e = elementorModules.frontend.handlers.Base.extend({
      ...
      run: function (e) {
        if (this.getElementSettings("tenweb_sticky")) {
          ...
          -1 !== this.getElementSettings("tenweb_sticky_on").indexOf(t)
            ? !0 === e
              ? this.reactivate()
      ...
      onElementChange: function (e) {
        -1 !== ["tenweb_sticky", "tenweb_sticky_on"].indexOf(e) && this.run(!0);
        -1 !==
          [
            ...this.getResponsiveSettingList("tenweb_sticky_offset"),
            ...this.getResponsiveSettingList("tenweb_sticky_effects_offset"),
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb-testimonial-carousel.default",
      function () {
        jQuery(".tenweb-testimonial-carousel-swiper").each(async function (
          s,
          o
        ) {
          var r = jQuery(o)
            .parents(".elementor-widget-twbb-testimonial-carousel")
            .attr("data-id");
          jQuery(o).attr("id", "tenweb-testimonial-carousel-swiper-" + r);
          var a = jQuery(o).data("settings");
          if (!jQuery.isEmptyObject(a)) {
            a.slidesPerView = { desktop: 1, tablet: 1, mobile: 1 };
            var l = {
              navigation: {
              ...
              breakpoints: {
                1280: {
                  slidesPerView: i("desktop", a),
                  spaceBetween: n("desktop", a),
                },
                768: {
                  slidesPerView: i("tablet", a),
                  spaceBetween: n("tablet", a),
                },
                320: {
                  slidesPerView: i("mobile", a),
                  spaceBetween: n("mobile", a),
                },
              },
            };
            "yes" == a.autoplay &&
            ...
            await new s(jQuery("#tenweb-testimonial-carousel-swiper-" + r), l);
          }
        });
      }
    );
    var s = elementorModules.frontend.handlers.Base.extend({
      ...
      getVerticalSpaceBetween() {
        ...
        let t = elementorFrontend.utils.controls.getResponsiveControlValue(
          this.getElementSettings(),
        ...
        return (
          (t =
            "" === t
              ? this.getElementSettings("space_between_masonry.size")
              : t.size),
          t
        );
      },
...
var _baseTabs = class extends elementorModules.frontend.handlers.Base {
    ...
    activateDefaultTab(e) {
      ...
      const i = this.getEditSettings("activeItemIndex") || e || 1,
        n = { showTabFn: t.showTabFn, hideTabFn: t.hideTabFn };
    ...
    handleKeyboardNavigation(e) {
      const t = e.currentTarget,
        ...
        n = i.find(this.getSettings("selectors").tabTitle),
        s = "vertical" === i.attr("aria-orientation");
      switch (e.key) {
        case "ArrowLeft":
        case "ArrowRight":
          if (s) return;
    ...
    deactivateActiveTab(e) {
      ...
      s.add(o).removeClass(i),
        s.attr({ tabindex: "-1", "aria-selected": "false" }),
        o[t.hideTabFn](),
    ...
    activateTab(e) {
      ...
      n.add(s).addClass(i),
        n.attr({ tabindex: "0", "aria-selected": "true" }),
        s[t.showTabFn](o, () =>
    ...
    changeActiveTab(e) {
      const t = this.isActiveTab(e),
        i = this.getSettings();
      (!i.toggleSelf && t) || !i.hidePrevious || this.deactivateActiveTab(),
        !i.hidePrevious && t && this.deactivateActiveTab(e),
  ...
  _playerBase = class {
    ...
    formatDuration(e) {
      const t = new Date(1e3 * e),
        ...
        s = t.getSeconds();
      return 0 !== i
        ? `${i.toString()}:${n.toString().padStart(2, "0")}:${s
            .toString()
            .padStart(2, "0")}`
        : `${n.toString()}:${s.toString().padStart(2, "0")}`;
    }
  },
  _playerYoutube = class extends _playerBase {
    ...
    create() {
      ...
      return new Promise((e) => {
        this.apiProvider.onApiReady((t) => {
          ...
          (this.playerObject = new t.Player(
            this.playlistItem.tabContent.querySelector("div"),
            i
          )),
            this.playerObject.addEventListener("onStateChange", (e) => {
              3 === e.data &&
                (2 === this.seekSequenceArray[this.seekSequenceArray.length - 1]
      ...
      this.playerObject.addEventListener("onStateChange", (t) => {
        2 === t.data &&
          ...
          (this.seekTimeOut = setTimeout(() => {
            2 === this.seekSequenceArray.length &&
            2 === this.seekSequenceArray[0] &&
            3 === this.seekSequenceArray[1]
              ? ((this.seekSequenceArray = []), clearTimeout(this.seekTimeOut))
              : (e(this.positionInVideoList), (this.isVideoPausedLocal = !0));
          }, 1e3)));
      });
    }
    handlePlayed(e) {
      this.playerObject.addEventListener("onStateChange", (t) => {
        1 !== t.data || this.isVideoEnded
          ? (this.isVideoEnded = !1)
          : (2 === this.seekSequenceArray.length &&
              2 === this.seekSequenceArray[0] &&
              3 === this.seekSequenceArray[1]) ||
    ...
    play() {
      this.isReady &&
        ((this.isVideoPlaying = !0), this.playerObject.playVideo());
    }
    pause() {
      this.isReady &&
        ((this.isVideoPlaying = !1), this.playerObject.pauseVideo());
    }
    mute() {
    ...
    async setVideoProviderData() {
      this.isReady &&
        (this.currentVideoID && 11 === this.currentVideoID.length
  ...
  _playerVimeo = class extends _playerBase {
    constructor(e, t) {
      super(e, t),
        ...
        (this.playerObject = null),
        (this.watchCount = 0),
        (this.isVideoInFullScreenChange = !1),
        (this.isReady = !1);
    }
    create() {
      return (
        ...
        new Promise((e) => {
          this.apiProvider.onApiReady((t) => {
            const i = { id: this.currentVideoID, autoplay: !1 };
            (this.playerObject = new t.Player(
              this.playlistItem.tabContent.querySelector("div"),
              i
            )),
    ...
    handlePaused(e) {
      this.playerObject.on("pause", (t) => {
        0 === t.percent ||
          t.percent >= 1 ||
          this.isVideoInFullScreenChange ||
          e(this.positionInVideoList);
      });
    }
    handlePlayed(e) {
    ...
    async setVideoProviderData() {
      ...
      const e = await this.playerObject.getVideoId(),
        ...
        i = await t.json();
      return (
        (this.playlistItem.duration = this.formatDuration(i[0].duration)),
        (this.playlistItem.video_title = i[0].title),
        (this.playlistItem.thumbnail = { url: i[0].thumbnail_medium }),
        this.playlistItem
      );
    }
  },
  _playerHosted = class extends _playerBase {
    ...
    create() {
      return new Promise((e) => {
        ...
        n.setAttribute("src", this.playlistItem.videoUrl),
          n.setAttribute(
            "type",
            "video/" + this.playlistItem.videoUrl.split(".").pop()
          ),
          t.appendChild(n),
          t.appendChild(i),
          (this.playerObject = t),
          this.playlistItem.tabContent
            .querySelector("div")
            .replaceWith(this.playerObject),
    ...
    handlePaused(e) {
      this.playerObject.addEventListener("pause", () => {
        this.seekTimeOut = setTimeout(() => {
          this.isVideoSeeking || this.isVideoEnded
            ? (this.isVideoEnded = !1)
            : (e(this.positionInVideoList), (this.isVideoPausedLocal = !0));
        }, 30);
      });
  ...
  _playlistEvent = class {
    constructor(e) {
      let { event: t, tab: i, playlist: n, video: s } = e;
      (this.event = {
        type: t.type || "",
        time: t.time || 0,
        element: t.element,
        ...
        (this.tab = { name: i.name, index: i.index }),
        (this.playlist = {
          name: n.name,
  ...
  _eventTrigger = {
    getEventTabsObject(e) {
      const t = e.elements.$innerTabs
        .filter(".e-active")
        .find(".e-inner-tabs-wrapper .e-inner-tab-title");
      if (t.length) {
        const e = t.filter(".e-inner-tab-active");
        return { name: e.text().trim(), index: e.index() + 1 };
      }
    ...
    getEventPlaylistObject(e, t) {
      ...
      return {
        ...
        currentItem: i,
        amount: e.playlistItemsArray.filter((e) => "section" !== e.videoType)
          .length,
      };
    },
    getEventVideoObject(e, t) {
      const i = t || e.currentPlaylistItemIndex,
        n = e.playlistItemsArray[i - 1];
      return {
        provider: n.videoType,
        url: n.videoUrl,
        title: n.videoTitle,
        duration: n.videoDuration,
      };
    },
    async getEventEventObject(e, t, i, n) {
      const s = n || e.currentPlaylistItemIndex,
        o = e.playlistItemsArray[s - 1];
      return {
        type: t,
    ...
    async triggerEvent(e, t, i, n) {
      const s = new _playlistEvent({
        event: await _eventTrigger.getEventEventObject(e, t, i, n),
        tab: _eventTrigger.getEventTabsObject(e),
        playlist: _eventTrigger.getEventPlaylistObject(e, n),
        video: _eventTrigger.getEventVideoObject(e, n),
      });
      jQuery("body").trigger("elementor-twbb_video-playList", s);
    },
  },
  _innerTabs = {
    toggleInnerTabs(e, t, i) {
      const n = e.currentTarget,
        s = n.querySelectorAll(".e-inner-tab-title");
      if (t.hasClass("e-inner-tab-active") || s.length < 2) return;
      const o = n.querySelectorAll(".e-inner-tab-content");
      s.forEach((e) => {
        ...
        _innerTabs.handleInnerTabsButtonsDisplay(
          Array.from(o),
          i.isCollapsible,
          i.innerTabsHeightLimit
        ),
        (0, _eventTrigger.triggerEvent)(i, "tabOpened", "click");
    },
    handleInnerTabs(e, t) {
      const i = e.target,
        n = i.tagName;
      if (i.classList.contains("e-inner-tab-title-text")) {
        e.preventDefault();
        const n = jQuery(i).parent(".e-inner-tab-title");
        _innerTabs.toggleInnerTabs(e, n, t);
      }
      if (i.classList.contains("e-tab-mobile-title")) {
        const n = jQuery(i);
        _innerTabs.toggleInnerTabs(e, n, t);
      }
      "button" === n.toLowerCase() && _innerTabs.onTabContentButtonsClick(e, t);
    },
    handleInnerTabsButtonsDisplay(e, t, i) {
      if (!t) return;
      const n = e.filter((e) => e.classList.contains("e-inner-tab-active")),
        s = n[0].querySelector(".e-inner-tab-text > div").offsetHeight,
        o = parseInt(i.size);
      o && s > o && n[0].classList.add("show-inner-tab-buttons");
    },
    onTabContentButtonsClick(e, t) {
      const i = jQuery(e.currentTarget)
        .find(".e-inner-tab-content")
        .filter(".e-inner-tab-active");
      i.find("button").toggleClass("show-button"),
        i.toggleClass("show-full-height");
      const n = i.hasClass("show-full-height") ? "tabExpanded" : "tabCollapsed";
      (0, _eventTrigger.triggerEvent)(t, n, "click");
    },
  },
  _urlParams = {
    handleURLParams(e, t) {
      ...
      if (!s) return !1;
      if (s === e) {
        const i = t.find((e) => n === e.dataItemId),
          s = i ? i.dataTab : 1;
        return s || setVideoParams(e, t, 1), s || !1;
      }
    },
    setVideoParams(e, t, i) {
      const n = new URLSearchParams(location.search);
      n.set("playlist", e),
        n.set("video", t[i - 1].dataItemId),
        history.replaceState({}, "", location.pathname + "?" + n);
    },
  },
  VideoPlaylistHandler = class extends _baseTabs {
    ...
    getDefaultElements() {
      ...
      return {
        ...
        $toggleVideosDisplayButton: this.findElement(
          t.toggleVideosDisplayButton
        ),
    ...
    onInit(...e) {
      ...
      (this.watchedVideosArray = t ? JSON.parse(t) : []),
        (this.watchedIndication = this.getElementSettings(
          "show_watched_indication"
        )),
        (0, _scrollUtils.handleVideosPanelScroll)(this.elements),
        (this.isAutoplayOnLoad =
          "yes" === this.getElementSettings("autoplay_on_load")),
        (this.isAutoplayNextUp =
          "yes" === this.getElementSettings("autoplay_next")),
    ...
    activateInitialVideo() {
      ...
      const e = !!this.getElementSettings("lazy_load"),
        t = (0, _urlParams.handleURLParams)(
          this.playlistId,
          this.playlistItemsArray
        );
      let i = !1;
      t
        ? ((this.currentPlaylistItemIndex = t),
          (this.currentPlayingPlaylistItemIndex = t),
          (i = !0))
        : ((this.currentPlaylistItemIndex = 1),
          (this.currentPlayingPlaylistItemIndex = 1)),
        this.isAutoplayOnLoad &&
          !i &&
          (0, _urlParams.setVideoParams)(
            this.playlistId,
            this.playlistItemsArray,
            this.currentPlaylistItemIndex
          ),
        this.handleFirstVideoActivation(e);
    }
    handleFirstVideoActivation(e) {
      if (!e)
        return void this.activateDefaultTab(this.currentPlaylistItemIndex);
      const t = document.querySelector(
          ".elementor-element-" + this.playlistId + " .e-tabs-main-area"
        ),
    ...
    async handleVideo(e) {
      if (e.playerInstance)
        ...
        (e.playerInstance = new t[e.videoType](
          e,
          this.currentPlaylistItemIndex
        )),
          e.playerInstance.create().then(() => {
            this.isVideoShouldBePlayed() && this.playVideoOnCreation(e),
              e.playerInstance.handleFullScreenChange((e) => {
                (0, _eventTrigger.triggerEvent)(
                  this,
              ...
              e.playerInstance.handlePlayed(() => {
                ...
                let i = "click";
                t.isAutoplayOnLoad
                  ? ((i = "onLoad"), (e.isAutoplayOnLoad = !1))
                  : t.isAutoPlayNextUp && (i = "nextVideo"),
                  (0, _eventTrigger.triggerEvent)(
                    this,
                    t.playerInstance.isVideoPausedLocal
                      ? "videoResume"
                      : "videoStart",
                    i
                  );
              ...
              e.playerInstance.handleEnded(() => {
                ...
                if (
                  (!this.watchedVideosArray.includes(e) &&
                    this.watchedIndication &&
                    (this.watchedVideosArray.push(
                      this.getCurrentItemSelected().dataItemId
                    ),
                    elementorFrontend.storage.set(
                      this.storageKey,
                      JSON.stringify(this.watchedVideosArray)
                    )),
                  this.isAutoplayNextUp &&
                    this.playlistItemsArray.length >=
                      ++this.currentPlaylistItemIndex)
                ) {
                  for (
                    ;
                    ...
                    if (
                      ...
                      return void (this.currentPlaylistItemIndex =
                        this.playlistItemsArray.length);
    ...
    createPlaylistItems() {
      (this.playlistItemsArray = []),
        this.elements.$videos.each((e, t) => {
          const i = {},
            n = jQuery(t);
          (i.videoUrl = n.attr("data-video-url")),
            (i.videoType = n.attr("data-video-type")),
            (i.videoTitle = n.attr("data-video-title")),
            (i.videoDuration = n.attr("data-video-duration")),
            (i.tabContent = t),
            (i.dataTab = e + 1),
            (i.dataItemId = this.getElementSettings().tabs[e]._id),
            this.playlistItemsArray.push(i);
        }),
        this.watchedVideosArray.length > 0 &&
          this.watchedIndication &&
          this.watchedVideosArray.forEach((e) => {
            const t = this.playlistItemsArray.find((t) => t.dataItemId === e);
            this.elements.$tabTitles
              .filter('[data-tab="' + t.dataTab + '"]')
              .addClass("watched-video");
          });
    }
    changeActiveTab(e, t) {
      if (
        (super.changeActiveTab(e),
        this.playlistItemsArray[e - 1] &&
          "section" !== this.playlistItemsArray[e - 1].videoType &&
          ...
          (this.isPageOnLoad = !1),
          jQuery(this.elements.$innerTabs.eq(e - 1)).find(
            ".e-inner-tab-content"
          ).length > 0))
      ) {
        const e = this.elements.$innerTabs
          .filter(".e-active")
          .find(".e-inner-tab-content");
        (0, _innerTabs.handleInnerTabsButtonsDisplay)(
          e.toArray(),
          this.isCollapsible,
...
jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb_video-playlist.default",
    function (e) {
      new VideoPlaylistHandler({ $element: e });
    }
  );
}),
  jQuery(window).on("elementor/frontend/init", function () {
    class e extends TWBB_WooCommerce_Base {
      ...
      bindEvents() {
        ...
        elementorFrontend.elements.$body.on("wc_fragments_refreshed", () =>
          ...
          "yes" === this.getElementSettings("update_cart_automatically") &&
            this.$element.on("input", e.quantityInput, () => this.updateCart()),
      ...
      onInit() {
        super.onInit(...arguments),
          ...
          jQuery(document).on(
            "click",
            ".elementor-widget-twbb_woocommerce-cart .twbb-product-quantity-change",
            function () {
              var e = jQuery(this).parent().find("input");
              return (
                jQuery(this).hasClass("twbb-minus-quantity")
      ...
      onElementChange(e) {
        "sticky_right_column" === e && this.toggleStickyRightColumn(),
          "additional_template_select" === e &&
            elementorTenweb.modules.woocommerce.onTemplateIdChange(
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-cart.default",
      function (t) {
        new e({ $element: t });
      }
    );
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-checkout-page.default",
      function (t) {
        new e({ $element: t });
      }
    );
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    class e extends elementorModules.frontend.handlers.Base {
      getDefaultSettings() {
        return {
          selectors: {
            ...
            closeButton:
              ".twbb_menu-cart__close-button, .twbb_menu-cart__close-button-custom",
            productList: ".twbb_menu-cart__products",
          },
          classes: { isShown: "twbb_menu-cart--shown" },
        };
      }
      getDefaultElements() {
        const e = this.getSettings("selectors");
      ...
      refreshFragments(e) {
        ...
        if (
          elementorFrontend.isEditMode() &&
          elementorTenweb.modules.woocommerce.didManuallyTriggerAddToCartEvent(
            t
          )
        )
          return !1;
        ...
        jQuery.each(elementorFrontend.documentsManager.documents, (e) => {
          ...
          jQuery.ajax({
            ...
            data: {
              ...
              templates: i,
              _nonce:
                ElementorTenwebFrontendConfig.woocommerce.menu_cart
                  .fragments_nonce,
      ...
      bindEvents() {
        const e = elementorTenwebFrontend.config.woocommerce.menu_cart,
          ...
          i = e.cart_page_url,
          n = e.cart_page_url === t,
          s = e.checkout_page_url === t,
          o = this.getSettings("selectors");
        if (n && s)
          return void this.$element.find(o.toggleButton).attr("href", i);
      ...
      onInit() {
        super.onInit(),
          elementorTenwebFrontend.config.woocommerce.productAddedToCart &&
      ...
      governDropdownHeight() {
        ...
        const s = document.documentElement.clientHeight,
          ...
          a = i.height(),
          l = s - r - o - (this.elements.$main.prop("scrollHeight") - a) - 30,
          c = Math.max(120, l);
        i.css("max-height", c);
      }
    }
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-menu-cart.default",
      function (t) {
        new e({ $element: t });
      }
    ),
      jQuery(document.body).on(
        "wc_fragments_loaded wc_fragments_refreshed",
        function () {
          jQuery("div.elementor-widget-twbb_woocommerce-menu-cart").each(
            function () {
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-my-account.default",
      function (t) {
        new e({ $element: t });
      }
    );
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    class e extends elementorModules.frontend.handlers.Base {
      ...
      moveNotices() {
        ...
        if (
          ((elementorFrontend.isEditMode() ||
            elementorFrontend.isWPPreviewMode()) &&
            (i = i.filter(":not(.e-notices-demo-notice)")),
          e && this.elements.$documentScrollToElements.stop(),
          this.elements.$noticesWrapper.prepend(i),
          this.is_ready ||
          ...
          e.length || (e = this.elements.$woocommerceCheckoutForm),
            e.length &&
              this.elements.$documentScrollToElements.animate(
                {
                  scrollTop:
                    e.offset().top - document.documentElement.clientHeight / 2,
                },
                1e3
              );
        }
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-notices.default",
      function (t) {
        new e({ $element: t });
      }
    );
  ...
  (function () {
    (this.MultiRange = function (e, t) {
      (t = "object" == typeof t ? t : {}),
        ...
        t.ticks && (this.settings.tickStep = this.delta / t.ticks),
      ...
      (MultiRange.prototype = {
        build: function (e) {
          var t =
            -1 == e.className.indexOf("multiRange")
              ? "multiRange " + e.className
              : e.className;
          (this.DOM.scope = document.createElement("div")),
            (this.DOM.scope.className = t),
            ...
            e.parentNode.replaceChild(this.DOM.scope, e);
        },
        generateTicks() {
          var e,
            t = this.delta / this.settings.tickStep,
            i = "";
          for (e = 0; e <= t; e++)
            i +=
              '<div data-value="' +
              (+this.settings.min + this.settings.tickStep * e)
                .toFixed(1)
                .replace(".0", "") +
              '"></div>';
          return i;
        ...
        getRangesHTML() {
          ...
          return (
            ...
            this.ranges[this.ranges.length - 1] <= this.settings.max &&
              this.ranges.push(this.settings.max),
            (e = this.ranges).forEach(function (n, s) {
              if (s != e.length - 1) {
                var o = ((n - t.settings.min) / t.delta) * 100;
                o < 0 && (o = 0),
                  (i +=
                    '<div data-idx="' +
                    s +
                    '" class="multiRange__range" style="left:' +
                    o +
                    '%"><div class="multiRange__handle"></div></div>'),
                  1 == s
                    ? jQuery(".current_min_price").html(
                        n.toFixed(1).replace(".0", "")
                      )
                    : 2 == s &&
                      jQuery(".current_max_price").html(
                        n.toFixed(1).replace(".0", "")
                      );
              }
            }),
        ...
        events: {
          binding: function () {
            this.DOM.rangeWrap.addEventListener(
              "mousedown",
              this.events.callbacks.onMouseDown.bind(this)
            ),
              this.DOM.rangeWrap.addEventListener(
                "touchstart",
                this.events.callbacks.onMouseDown.bind(this)
          ...
          callbacks: {
            onMouseDown: function (e) {
              var t = e.target;
              if (t) {
                if ("multiRange__handle__value" == t.className)
                  t = t.parentNode;
                else if ("multiRange__handle" != t.className) return;
                var i = this.DOM.scope.getBoundingClientRect();
                (this.offsetLeft = i.left),
                  (this.scopeWidth = i.width),
                  (this.DOM.currentSlice = t.parentNode),
                  this.DOM.currentSlice.classList.add("grabbed"),
                  (this.DOM.currentSliceValue =
                    this.DOM.currentSlice.querySelector(
                      ".multiRange__handle__value"
                    )),
                  document.body.classList.add("multiRange-grabbing"),
                  (this.events.onMouseUpFunc =
                    this.events.callbacks.onMouseUp.bind(this)),
                  (this.events.mousemoveFunc =
                    this.events.callbacks.onMouseMove.bind(this)),
              ...
              var t,
                ...
                n =
                  ((e.touches
                    ...
                    this.scopeWidth) *
                  100,
                s = this.ranges[+this.DOM.currentSlice.dataset.idx - 1],
                o = this.ranges[+this.DOM.currentSlice.dataset.idx + 1];
              (t = this.settings.min + (this.delta / 100) * n),
                this.settings.step &&
                  (t = Math.round(t / this.settings.step) * this.settings.step),
                t < s + this.settings.minRange &&
                  (t = s + this.settings.minRange),
                t > o - this.settings.minRange &&
                  (t = o - this.settings.minRange),
                t < this.settings.min + this.settings.minRange &&
                  (t = this.settings.min + this.settings.minRange),
                t > this.settings.max - this.settings.minRange &&
                  (t = this.settings.max - this.settings.minRange),
                (n = ((t - this.settings.min) / this.delta) * 100),
                window.requestAnimationFrame(function () {
                  i.DOM.currentSlice &&
                    (i.DOM.currentSlice.style.left = n + "%");
                }),
                (this.ranges[this.DOM.currentSlice.dataset.idx] =
                  +t.toFixed(1)),
                (this.currentMinPriceDOM = jQuery(this.DOM.scope)
                  .closest(".twbb_woo_price_filter")
                  .children(".twbb_woo_price_filter-info")
                  .children(".twbb_woo_price_filter-info-price_range")
                  .children("span")
                  .children(".current_min_price")),
                (this.currentMaxPriceDOM = jQuery(this.DOM.scope)
                  .closest(".twbb_woo_price_filter")
                  .children(".twbb_woo_price_filter-info")
                  .children(".twbb_woo_price_filter-info-price_range")
                  .children("span")
                  .children(".current_max_price")),
...
for (let e = 0; e < priceFilters.length; e++)
  new MultiRange(document.querySelectorAll(".multiRange")[e], {
...
jQuery(".twbb_woo_price_filter").submit(function (e) {
  ...
  t.searchParams.delete("product-page"),
    window.history.pushState(null, null, t.href),
    this.submit();
}),
  jQuery(window).on("elementor/frontend/init", function () {
    class e extends TWBB_WooCommerce_Base {
      ...
      handleAddedToCart(e) {
        const t = this.getSettings("selectors"),
          ...
          n = i.parents(t.loopFormContainer);
        n.children(t.addedToCartButton).remove(), n.append(i);
      }
      bindEvents() {
        super.bindEvents(...arguments),
          ...
          elementorFrontend.elements.$body.off(
            "added_to_cart.twbb_woocommerce-product-add-to-cart"
          ),
          elementorFrontend.elements.$body.on(
            "added_to_cart.twbb_woocommerce-product-add-to-cart",
            (e, t, i, n) => {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-product-add-to-cart.default",
      function (t) {
        new e({ $element: t });
      }
    );
...
function productsAjaxPagination(e) {
  const t = e.find("a").attr("href"),
    ...
    n = e.closest(".elementor-widget-twbb_woocommerce-products").data("id");
  jQuery.ajax({
    url: t,
    type: "GET",
    dataType: "html",
    success: function (e) {
      const t = new DOMParser().parseFromString(e, "text/html"),
        s = jQuery(t)
          .find(
            '.elementor-widget-twbb_woocommerce-products[data-id="' + n + '"]'
          )
          .html();
      i.html(s),
        jQuery(".twbb_woocommerce-products-ajax-paginate .page-numbers li").on(
          "click",
          function (e) {
...
function changeProductQuantity(e) {
  let t = jQuery(e)
    .closest("li.product")
    .find("input.twbb-product-quantity-input")
    .val();
  jQuery(e).attr("data-quantity", t);
}
jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    "frontend/element_ready/twbb_woocommerce-product-data-tabs.default",
    function (e) {
      jQuery("body .elementor-widget-twbb_woocommerce-product-data-tabs")
        .length > 1 &&
      ...
      if (4 < t.find("ol.flex-control-thumbs li").length) {
        i.addClass("swiper-wrapper"),
          ...
          void 0 !== twbb.swiper_latest && "inactive" == twbb.swiper_latest
            ...
            : t.append(
                jQuery(
                  '<div class="swiper-button-prev twbb-swiper-last"></div><div class="swiper-button-next twbb-swiper-last"></div>'
                )
              );
        var s = function () {
          t.find(".swiper-button-prev, .swiper-button-next").css(
            "top",
            "calc(100% - " + t.find(".swiper-slide").height() / 2 + "px)"
          );
        };
        const e = elementorFrontend.utils.swiper;
        await new e(t, {
          ...
          on: { imagesReady: s, resize: s },
        });
      }
    };
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-product-images.default",
      e
    ),
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/twbb_woocommerce-page.default",
        e
      );
  }),
  jQuery(window).on("elementor/frontend/init", function () {
    jQuery(document).on(
      "click",
      ".elementor-widget-twbb_woocommerce-page .twbb-product-quantity-change",
      function () {
        var e = jQuery(this).parent().find("input");
        return (
          jQuery(this).hasClass("twbb-minus-quantity")
      ...
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/twbb_woocommerce-page.default",
        function (e) {
          jQuery("body .elementor-widget-twbb_woocommerce-page").length > 1 &&
            (alert(
              "The page already includes a WooCommerce Pages Widget element."
            ),
            elementor
              .getPanelView()
              .getCurrentPageView()
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    jQuery(".twbb_woocommerce-products-ajax-paginate .page-numbers li").on(
      ...
      jQuery(
        ".elementor-widget-twbb_woocommerce-products .add_to_cart_button"
      ).on("click", function (e) {
  ...
  jQuery(window).on("elementor/frontend/init", function () {
    class e extends TWBB_WooCommerce_Base {
      ...
      onElementChange(e) {
        ...
        for (const i of t)
          e.startsWith(i) && this.equalizeElementHeight(this.elements.$address);
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/twbb_woocommerce-purchase-summary.default",
      function (t) {
        new e({ $element: t });
      }
    );
