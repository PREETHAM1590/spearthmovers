...
!(function (a, b) {
  ...
  !(function (a, b) {
    ...
    return (
      (a.ChildViewContainer = (function (a, b) {
        var c = function (a) {
          (this._views = {}),
            (this._indexByModel = {}),
            (this._indexByCustom = {}),
    ...
    (function (a, b) {
      ...
      return (
        ...
        (d.Commands = (function (a, b) {
          return a.Handlers.extend({
            ...
            execute: function (a) {
              ...
              this.hasHandler(a)
                ? this.getHandler(a).apply(this, c)
                : this.storage.addCommand(a, c);
            },
        ...
        (d.RequestResponse = (function (a, b) {
          return a.Handlers.extend({
            request: function (a) {
              return this.hasHandler(a)
                ? this.getHandler(a).apply(this, b.rest(arguments))
                : void 0;
            },
          });
        })(d, b)),
        (d.EventAggregator = (function (a, b) {
          var c = function () {};
          return (
            (c.extend = a.Model.extend), b.extend(c.prototype, a.Events), c
          );
        })(a, b)),
  ...
  (f.VERSION = "2.4.5"),
    ...
    (f.normalizeUIValues = function (a, b, d) {
      return (
        c.each(a, function (e, g) {
          c.isString(e)
            ? (a[g] = f.normalizeUIString(e, b))
            : c.isObject(e) &&
              c.isArray(d) &&
              (c.extend(e, f.normalizeUIValues(c.pick(e, d), b)),
              c.each(d, function (a) {
                var d = e[a];
  ...
  var g = (f.deprecate = function (a, b) {
    c.isObject(a) &&
      ...
      (void 0 !== b && b) ||
        g._cache[a] ||
        (g._warn("Deprecation warning: " + a), (g._cache[a] = !0));
  });
  (g._console = "undefined" != typeof console ? console : {}),
    ...
    (f._triggerMethod = (function () {
      ...
      return function (d, e, f) {
        ...
        var h,
          ...
          j = d[i];
        return (
          c.isFunction(j) && (h = j.apply(d, g ? c.rest(f) : f)),
          c.isFunction(d.trigger) &&
            (g + f.length > 1
              ? d.trigger.apply(d, g ? f : [e].concat(c.drop(f, 0)))
              : d.trigger(e)),
          h
        );
      };
    ...
    (f.MonitorDOMRefresh = function (a) {
      ...
      function d() {
        a._isShown &&
          a._isRendered &&
          f.isNodeAttached(a.el) &&
          f.triggerMethodOn(a, "dom:refresh", a);
      }
      a._isDomRefreshMonitored ||
        ((a._isDomRefreshMonitored = !0), a.on({ show: b, render: c }));
    }),
    (function (a) {
      function b(b, d, e, f) {
        var g = f.split(/\s+/);
  ...
  return (
    ...
    c.extend(f.Callbacks.prototype, {
      ...
      run: function (a, b) {
        this._deferred.resolve({ options: a, context: b });
      },
      reset: function () {
    ...
    c.extend(f.Controller.prototype, b.Events, {
      destroy: function () {
        return (
          f._triggerMethod(this, "before:destroy", arguments),
    ...
    (f.Region = f.Object.extend(
      {
        ...
        show: function (a, b) {
          if (this._ensureElement()) {
            ...
            if (
              (i &&
                this.triggerMethod("before:swapOut", this.currentView, this, b),
              this.currentView && e && delete this.currentView._parent,
              j
                ? this.empty()
                : i && k && this.currentView.off("destroy", this.empty, this),
              k)
            ) {
              ...
              return (
                l &&
                  n.triggerBeforeAttach &&
                  ((m = this._displayedViews(a)),
                  this._triggerAttach(m, "before:")),
                this.attachHtml(a),
                (this.currentView = a),
                l &&
                  n.triggerAttach &&
                  ((m = this._displayedViews(a)), this._triggerAttach(m)),
        ...
        _ensureElement: function () {
          if (
            (c.isObject(this.el) ||
              ((this.$el = this.getEl(this.el)), (this.el = this.$el[0])),
        ...
        _destroyView: function () {
          ...
          a.isDestroyed ||
            (a.supportsDestroyLifecycle ||
              f.triggerMethodOn(a, "before:destroy", a),
            a.destroy ? a.destroy() : (a.remove(), (a.isDestroyed = !0)),
    ...
    (f.RegionManager = f.Controller.extend({
      ...
      addRegions: function (a, b) {
        return (
          (a = f._getValue(a, this, arguments)),
          c.reduce(
            a,
            function (a, d, e) {
              return (
                c.isString(d) && (d = { selector: d }),
      ...
      addRegion: function (a, b) {
        var c;
        return (
          (c = b instanceof f.Region ? b : f.Region.buildRegion(b, f.Region)),
    ...
    c.extend(f.TemplateCache, {
      ...
      get: function (a, b) {
        ...
        return (
          c || ((c = new f.TemplateCache(a)), (this.templateCaches[a] = c)),
          c.load(b)
        );
      },
      clear: function () {
        var a,
          ...
          d = b.length;
        if (d > 0) for (a = 0; d > a; a++) delete this.templateCaches[b[a]];
    ...
    c.extend(f.TemplateCache.prototype, {
      load: function (a) {
        ...
        return (
          (this.compiledTemplate = this.compileTemplate(b, a)),
    ...
    (f.View = b.View.extend({
      ...
      undelegateEvents: function () {
        return (
          b.View.prototype.undelegateEvents.apply(this, arguments),
      ...
      destroy: function () {
        ...
        return (
          this.triggerMethod.apply(this, ["before:destroy"].concat(a)),
          (this.isDestroyed = !0),
      ...
      _buildViewTrigger: function (a) {
        var b = c.defaults({}, a, { preventDefault: !0, stopPropagation: !0 }),
          d = c.isObject(a) ? b.event : a;
        return function (a) {
          a &&
            (a.preventDefault && b.preventDefault && a.preventDefault(),
    ...
    (f.ItemView = f.View.extend({
      ...
      serializeData: function () {
        ...
        return (
          arguments.length && a.push.apply(a, arguments),
          this.model
            ? this.serializeModel.apply(this, a)
    ...
    (f.CollectionView = f.View.extend({
      ...
      _onCollectionAdd: function (a, b, d) {
        ...
        if (
          ((this.getOption("filter") || e === !1) &&
            (e = c.indexOf(this._filteredSortedModels(e), a)),
      ...
      _filteredSortedModels: function (a) {
        ...
        if (((a = Math.min(Math.max(a, 0), d.length - 1)), b)) {
          var e;
          a && ((e = d[a]), (d = d.slice(0, a).concat(d.slice(a + 1)))),
      ...
      removeChildView: function (a) {
        return a
          ? (this.triggerMethod("before:remove:child", a),
            a.supportsDestroyLifecycle ||
              f.triggerMethodOn(a, "before:destroy", a),
      ...
      _createBuffer: function () {
        ...
        return (
          c.each(this._bufferedChildren, function (b) {
            a.appendChild(b.el);
          }),
          a
        );
      ...
      attachHtml: function (a, b, c) {
        a.isBuffering
          ? a._bufferedChildren.splice(c, 0, b)
          : a._insertBefore(b, c) || a._insertAfter(b);
      },
      _insertBefore: function (a, b) {
        ...
        return (
          d &&
            (c = this.children.find(function (a) {
              return a._index === b + 1;
            })),
      ...
      destroyChildren: function (a) {
        ...
        return (
          c.isUndefined(b.checkEmpty) || (d = b.checkEmpty),
    ...
    (f.CompositeView = f.CollectionView.extend({
      ...
      getChildViewContainer: function (a, b) {
        ...
        if (d) {
          ...
          if (
            ((c = "@" === e.charAt(0) && a.ui ? a.ui[e.substr(4)] : a.$(e)),
            c.length <= 0)
          )
            throw new f.Error({
    ...
    (f.LayoutView = f.ItemView.extend({
      ...
      destroy: function () {
        return this.isDestroyed
          ? this
          : (this.getOption("destroyImmediate") === !0 && this.$el.remove(),
      ...
      addRegions: function (a) {
        return (
          (this.regions = c.extend({}, this.regions, a)), this._buildRegions(a)
        );
      },
      removeRegion: function (a) {
    ...
    (f.Behaviors = (function (a, b) {
      function c(a, d) {
        return b.isObject(a.behaviors)
          ? ((d = c.parseBehaviors(a, d || b.result(a, "behaviors"))),
            c.wrap(a, d, b.keys(g)),
            d)
          : {};
      }
      ...
      return (
        b.extend(c, {
          ...
          getBehaviorClass: function (b, d) {
            return b.behaviorClass
              ? b.behaviorClass
              : a._getValue(c.behaviorsLookup, this, [b, d])[d];
          },
    ...
    (f.AppRouter = b.Router.extend({
      ...
      _addAppRoute: function (a, b, d) {
        ...
        if (!e)
          throw new f.Error(
            'Method "' + d + '" was not found on the controller'
          );
    ...
    (f.Application = f.Object.extend({
      ...
      _initializeRegions: function (a) {
        var b = c.isFunction(this.regions)
          ? this.regions(a)
          : this.regions || {};
        this._initRegionManager();
        var d = f.getOption(a, "regions");
        return (
          c.isFunction(d) && (d = d.call(this, a)),
          c.extend(b, d),
          this.addRegions(b),
          this
        );
      ...
      _initChannel: function () {
        (this.channelName = c.result(this, "channelName") || "global"),
          (this.channel =
            c.result(this, "channel") ||
            b.Wreqr.radio.channel(this.channelName)),
    ...
    c.extend(f.Module, {
      ...
      _getModule: function (a, b, d, e, f) {
        var g = c.extend({}, e),
          ...
          i = a[b];
        return (
          i || ((i = new h(b, d, g)), (a[b] = i), (a.submodules[b] = i)), i
        );
      },
      getClass: function (a) {
        var b = f.Module;
      ...
      _getStartWithParent: function (a, b) {
        var d;
        return c.isFunction(a) && a.prototype instanceof f.Module
          ? ((d = b.constructor.prototype.startWithParent),
            c.isUndefined(d) ? !0 : d)
          : c.isObject(a)
          ? ((d = a.startWithParent), c.isUndefined(d) ? !0 : d)
          : !0;
      },
