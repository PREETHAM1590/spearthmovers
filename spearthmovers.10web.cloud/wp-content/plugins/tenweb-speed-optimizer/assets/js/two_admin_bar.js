jQuery("document").ready(function () {
  ...
  jQuery("body").on("click", ".two_el_id", function () {
    var two_css_options_list = jQuery(this)
      .closest("li")
      .find(".two_css_options_list");
  ...
  jQuery.each(sheets, function (index, value) {
    ...
    if (
      ...
      el_flag = value.href;
      if (
        value.ownerNode.id !== null &&
        value.ownerNode.id !== "" &&
        typeof value.ownerNode.id !== "undefined"
      ) {
    ...
    var two_style_options =
      "<div class='two_css_options_list two_hidden'>" +
      ...
      "<input " +
      two_async_page_check +
      " name='" +
      uid +
      "' data-two_action='two_async_page' " +
      two_async_page_class +
      " type='radio'>" +
      "<span class='wxao_checkmark'></span>" +
      "</label>" +
      "</div>" +
      ...
      "<input " +
      two_disabled_page_check +
      " name='" +
      uid +
      "' data-two_action='two_disable_page' " +
      two_disabled_page_class +
      " type='radio'>" +
      "<span class='wxao_checkmark'></span>" +
      "</label>" +
      "</div>";
    ...
    if (!flag && el_flag !== null && el_flag !== "") {
      two_styles_list +=
        "<li class='two_options_section' title='" +
        el_flag +
        "' data-el_href='" +
        el_href +
        "' data-el_data_id='" +
  ...
  jQuery(".two_checked").each(function () {
    if (
      jQuery(this).data("two_action") === "two_disable_page" ||
      jQuery(this).data("two_action") === "two_disable"
    ) {
  ...
  jQuery("body").on("click", ".two_css_options_list input", function () {
    ...
    if (jQuery(this).hasClass("two_checked")) {
      ...
      jQuery(this)
        .closest(".two_options_section")
        .removeClass("two_check_section");
    ...
    if (jQuery(this).is(":checked")) {
      jQuery(this)
        .closest(".two_css_options_list")
        .find("input")
        .removeClass("two_checked");
      jQuery(this).addClass("two_checked");
      jQuery(this)
        .closest(".two_options_section")
        .addClass("two_check_section");
